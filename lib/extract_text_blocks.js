...
var compile = function(phrase, defaultValue, options) {
  return I18N_DIRECTIVE({
    phrase: phrase,
...
var extract = function(textBlock, dontCompile) {
  ...
  var i18n = {
    ...
    options: {},
    recompile: function() {
      return compile(i18n.phrase, i18n.defaultValue, i18n.options);
    }
  };
  ...
  if (!dontCompile) {
    i18n.stringValue = i18n.recompile();
  }
